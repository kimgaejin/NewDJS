...
public class UIM : MonoBehaviour
{
    ...
    public GameObject[] level5 = new GameObject[5];
    public int stage1;
    public int stage2;
    public int stage3;
    public int stage4;
    ...
    {    
        ...
        stage5 = PlayerPrefs.GetInt("StageB5"); //게임 시작시 현재까지 깬 스테이지 로드
        ...
        Debug.Log("현재 스테이지" + stage1 + "   " + stage2 + "   " + stage3 + "   " + stage4+ "    " +stage5);
        for (int i = 0; i < 5; i++) {
